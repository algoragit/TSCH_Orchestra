    ...
    mkdir result_files
        ...
        # done
            ...
            do
                ...
                do
                    mv $filename"_results.csv" "result_files/tsch_"$filename"_results_"$density"_iteration-"$j".csv"
                done

                mv "packets.dat" "result_files/tsch_"$density"_iteration-"$j".dat"
                mv "COOJA.testlog" "result_files/testlog_tsch_"$density"_iteration-"$j".txt"
            done 
            #rm udp-sender.c
