...
while(true){&#xD;
  ...
  if (message.length == 3 || message.length == 4) {&#xD;
    ...
    msg_tx += parseInt(message[1]);&#xD;
    rx_time += parseInt(message[2]);&#xD;
    tx_time += parseInt(message[3]);&#xD;
    lpm_time += parseInt(message[4]);&#xD;
    cpu_time += parseInt(message[5]);&#xD;
